                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="product-1" role="tabpanel">
                                            <div class="product-img">
                                                ...
                                                try {
                                                   //code...
                                                   $path= $professeur->user->docFiles->where('type','profileImg')->first()->path;
                                               } catch (\Throwable $th) {
                    ...
                    <div class="col-xl-9">
                        <div class="mt-4 mt-xl-3">
                          ...
                          @endif
                            ...
                            <h5 class="mt-3 mb-3">@if($professeur!=null) {{Str::upper($professeur->user->lastname) }} {{$professeur->user->firstname}}@endif</h5>
                            <h6 class="mt-3 text-muted "> <i class="mdi mdi-email mr-1 align-middle"></i> {{($professeur==null)?'NaN':$professeur->user->email}} </h6>
...
<!-- end row -->
@if($professeur->user->id == Auth::id())
@include('professeur.profile.edit')
@else
@include('professeur.profile.message')
@endif
@endsection
@section('script')
